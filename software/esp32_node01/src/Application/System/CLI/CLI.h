...
void InitCLI(){
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor01].path = "521";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor01].text = "Set Speed Motor 01";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor01].Callback = F_CLI_Modules_Motors_SetSpeedMotor01;

    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor02].path = "522";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor02].text = "Set Speed Motor 02";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor02].Callback = F_CLI_Modules_Motors_SetSpeedMotor02;

    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor03].path = "523";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor03].text = "Set Speed Motor 03";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor03].Callback = F_CLI_Modules_Motors_SetSpeedMotor03;

    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor04].path = "524";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor04].text = "Set Speed Motor 04";
    CLIOptions[CLIOptions_e::CLI_Modules_Motors_SetSpeedMotor04].Callback = F_CLI_Modules_Motors_SetSpeedMotor04;

    CLIOptions[CLIOptions_e::CLI_Modules_Motors_PrintInfo].path = "525";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders].path = "53";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders_Status].path = "531";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders_SetValues].path = "532";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders_SetValues_SetCountEncoderLeft].path = "5321";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders_SetValues_SetCountEncoderRight].path = "5322";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Encoders_PrintInfo].path = "533";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry].path = "54";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_Status].path = "541";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_SetValues].path = "542";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_SetValues_SetX].path = "5421";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_SetValues_SetY].path = "5422";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_SetValues_SetDistance].path = "5423";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Odometry_SetValues_SetAngle].path = "5424";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion].path = "55";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_Start].path = "551";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_Stop].path = "552";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_ShowSP].path = "553";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_SetSPAngle].path = "554";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_SetSPPosition].path = "555";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam].path = "556";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_Show].path = "5561";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_Kp].path = "5562";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_Ki].path = "5563";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_Kd].path = "5564";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_MVmin].path = "5565";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDPosParam_MVmax].path = "5566";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam].path = "557";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_Show].path = "5571";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_Kp].path = "5572";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_Ki].path = "5573";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_Kd].path = "5574";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_MVmin].path = "5575";
    ...
    CLIOptions[CLIOptions_e::CLI_Modules_Motion_PIDAngleParam_MVmax].path = "5576";
    ...
    CLIOptions[CLIOptions_e::CLI_Datalog_Datasets_Odometry].path = "732";
    ...
    CLIOptions[CLIOptions_e::CLI_Datalog_Datasets_Odometry_Activate].path = "7321";
    ...
    CLIOptions[CLIOptions_e::CLI_Datalog_Datasets_Odometry_Deactivate].path = "7322";
...
void F_CLI_Modules_Motors_SetSpeedMotor01(){
    float res = 0.0;
    Serial.println("Enter Speed of the Motor 01:");
    ActivateGetValueModeCLI();
    if (!insertedValueCLI.equals("")){
        res = insertedValueCLI.toFloat();
        manager->m_motor01->SetSpeed(res);
        Serial.println("Motor 01 Speed: " + String(manager->m_motor01->GetSpeed()));
    }
}
...
void F_CLI_Modules_Motors_SetSpeedMotor02(){
    float res = 0.0;
    Serial.println("Enter Speed of the Motor 02:");
    ActivateGetValueModeCLI();
    if (!insertedValueCLI.equals("")){
        res = insertedValueCLI.toFloat();
        manager->m_motor02->SetSpeed(res);
        Serial.println("Motor 02 Speed: " + String(manager->m_motor02->GetSpeed()));
    }
}
...
void F_CLI_Modules_Motors_SetSpeedMotor03(){
    float res = 0.0;
    Serial.println("Enter Speed of the Motor 03:");
    ActivateGetValueModeCLI();
    if (!insertedValueCLI.equals("")){
        res = insertedValueCLI.toFloat();
        manager->m_motor03->SetSpeed(res);
        Serial.println("Motor 03 Speed: " + String(manager->m_motor03->GetSpeed()));
    }
}
...
void F_CLI_Modules_Motors_SetSpeedMotor04(){
    float res = 0.0;
    Serial.println("Enter Speed of the Motor 04:");
    ActivateGetValueModeCLI();
    if (!insertedValueCLI.equals("")){
        res = insertedValueCLI.toFloat();
        manager->m_motor04->SetSpeed(res);
        Serial.println("Motor 04 Speed: " + String(manager->m_motor04->GetSpeed()));
    }
}
...
void F_CLI_Modules_Motors_PrintInfo(){
    manager->m_motor01->Print();
    manager->m_motor02->Print();
    manager->m_motor03->Print();
    manager->m_motor04->Print();
}
...
void F_CLI_Modules_Encoders_Status(){
    Serial.println("Encoder 01 Count: " + String(manager->m_encoder01->GetCount()));
    Serial.println("Encoder 02 Count: " + String(manager->m_encoder02->GetCount()));
    Serial.println("Encoder 03 Count: " + String(manager->m_encoder03->GetCount()));
    Serial.println("Encoder 04 Count: " + String(manager->m_encoder04->GetCount()));
}
...
void F_CLI_Modules_Encoders_SetValues_SetCountEncoderLeft(){
    ...
    if (!insertedValueCLI.equals("")){
        ...
        manager->m_encoder01->SetCount(res);
        Serial.println("Left encoder count: " + String(manager->m_encoder01->GetCount()));
    }
}
...
void F_CLI_Modules_Encoders_SetValues_SetCountEncoderRight(){
    ...
    if (!insertedValueCLI.equals("")){
        res = insertedValueCLI.toInt();
        manager->m_encoder02->SetCount(res);
        Serial.println("Right encoder count: " + String(manager->m_encoder02->GetCount()));
    }
}
...
void F_CLI_Modules_Encoders_PrintInfo(){
    manager->m_encoder01->Print();
    manager->m_encoder02->Print();
}
