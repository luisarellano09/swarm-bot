 ...
 */
#define NODE_ESP32s_TX_GPIO 19

/**
 * @brief NODE_ESP32s_RX
 */
#define NODE_ESP32s_RX_GPIO 21
 ...
 * @brief TFT SPI SCK
 */
#define TFT_SCLK_GPIO 23

/** 
 * @brief TFT SPI SDA
 */
#define TFT_MOSI_GPIO 22
 ...
 */
#define SERVO_CONTROLLER_TX_GPIO 5

/**
 * @brief SERVO CONTROLLER RX
 */
#define SERVO_CONTROLLER_RX_GPIO 34
