...
void F_CLI_Test_Test1(){
    // Add servo request
    manager->m_servoController->AddRequest(1, 100, 100);
...
void F_CLI_Test_Test2(){
    // Add servo request
    manager->m_servoController->AddRequest(1, 0, 3000);
...
void F_CLI_Test_Test3(){
    // Add servo request
    manager->m_servoController->AddRequest(1, 50, 100);
}
