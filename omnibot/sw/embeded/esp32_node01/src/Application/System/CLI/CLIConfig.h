...
enum CLIOptions_e {
    ...
    CLI_Modules_Motors,
    CLI_Modules_Motors_SetSpeedMotor01,
    CLI_Modules_Motors_SetSpeedMotor02,
    CLI_Modules_Motors_SetSpeedMotor03,
    CLI_Modules_Motors_SetSpeedMotor04,
    ...
    CLI_Modules_Motion_PIDAngleParam_Show,
